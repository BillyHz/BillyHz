...
- **[HexLauncher](https://github.com/BillyHz/HexLauncher)** — Minecraft No Premium Launcher (Python)
- **[face-detector-ia](https://github.com/BillyHz/face-detector-ia)** — computer vision experiments (Python)
- **[Zoinks](https://github.com/BillyHz/Zoinks)** — keeps this graph green (GitHub Actions + diary.md)
